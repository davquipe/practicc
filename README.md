...
Ejecute `ng build` para construir el proyecto Los artefactos de construcción se almacenarán en `dist/` directorio. Utilizar el `-prod` bandera para una construcción de producción.
